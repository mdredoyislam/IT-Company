...
class redoyit_widget extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            ...
            __( 'RedoyIT: Social Icons', 'philosophy' ), // Name
...
function redoyit_social_icons_widget() {
    register_widget( 'redoyit_widget' );
}

add_action( 'widgets_init', 'redoyit_social_icons_widget' );